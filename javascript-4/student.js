...
const faveColors = ['green', 'blue','teal']
...
const me = {
    firstname: 'Aaron', 
    superHeroName: 'Mega Mind', 
    homeTown: "StLouis", 
    superPowers: ['mind', 'strength', 'mindreading'], 
...
//The first variable should be 'regularName' 
//that is the value of your firstName on the me object. 
...
// Just to make sure that we only ever have three colors, 
...
// The createLi function is a function we created to set the data on the 
//      screen. 
