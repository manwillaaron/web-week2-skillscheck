...
myNumbersIndex = myNumbers.forEach(function(curVal, index) {
...
const notGeorge = ['Louis', 'Ted', 'Bill', 'Sharon', 'Mark', 'Angela']
 ...
 let forTheLoveOfGeorge = notGeorge.map(function(curr) {
	return curr = 'George'
})
...
const totallyAwesome = people.reduce(function(preVal, curr) {
	return preVal += awesomeLevel[curr]
}, 0)
